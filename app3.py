...
st.markdown('_Markdown_') # see #* 마크다운이랑 같음. #넣으면 큰글씨됨
st.caption('Balloons. Hundreds of them...')
st.latex(r''' e^{i\pi} + 1 = 0 ''') # 인터넷이 문법 찾아보면 잘 나옴. 
st.write('Most objects') # df, err, func, keras! / 아까 data 저장한거 (data)로 넣으면 바로 화면에 데이터 프레임으로 넣어줌. 
# f{변수}처럼 그대로 출력해준다  
...
# 화면단을 나눌려면? cheat sheet의 columns 참고 
